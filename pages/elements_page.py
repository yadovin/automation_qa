...
class TextBoxPage(BasePage):
    ...
    def check_filled_form(self):
        full_name = self.element_is_visible(self.locators.CREATE_FULL_NAME).text.split(':')[1]
        email = self.element_is_visible(self.locators.CREATE_EMAIL).text.split(':')[1]
        current_address = self.element_is_visible(self.locators.CREATE_CURRENT_ADDRESS).text.split(':')[1]
        permanent_address = self.element_is_visible(self.locators.CREATE_PERMANENT_ADDRESS).text.split(':')[1]
        return full_name, email, current_address, permanent_address
...
class UploadAndDownloadPage(BasePage):
    ...
    def download_file(self):
        ...
        path_name_file = rf'C:\QA\filetest{random.randint(0, 999)}.jpg'
...
class DynamicPropertiesPage(BasePage):
    ...
    def check_enable_button(self):
        ...
        try:
            self.elements_is_clickable(self.locators.ENABLE_BUTTON)
