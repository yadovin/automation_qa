...
from locators.widgets_page_locators import AccordianPageLocators, AutoCompletePageLocators, DatePickerPageLocators, \
    SliderPageLocators, ProgressBarLocators, ToolTipsPageLocators, MenuPageLocators
...
class DatePickerPage(BasePage):
    ...
    def select_date_and_time(self):
        ...
        value_date_before = input_date.get_attribute('value')
        input_date.click()
        self.elements_is_clickable(self.locators.DATE_AND_TIME_MONTH).click()
        self.set_date_item_from_list(self.locators.DATE_AND_TIME_MONTH_LIST, date.month)
        self.elements_is_clickable(self.locators.DATE_AND_TIME_YEAR).click()
...
class ProgressBarPage(BasePage):
    ...
    def changed_progress_bar_value(self):
        value_before = self.element_is_present(self.locators.PROGRESS_BAR_VALUE).text
        progress_bar_button = self.elements_is_clickable(self.locators.PROGRESS_BAR_BUTTON)
